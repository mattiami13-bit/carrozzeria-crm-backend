...
const AZIONI = {
  ...
  "POST /api/gdpr/export-asincrono": { azione: "richiesta export dati tenant (asincrono)" },
  "GET /api/gdpr/export-asincrono/:id/download": { azione: "download link export dati tenant", tracciaSempre: true },
  "POST /api/gdpr/annulla-cancellazione-account": { azione: "annullata cancellazione account (GDPR)" },
